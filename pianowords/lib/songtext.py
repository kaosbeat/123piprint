...
def stopSong():
	...
	if tweeting:
		...
		subprocess.check_output(('convert', '-pointsize', '10', '-font', 'Courier', '-page', '500x'+str(countlines*15), '-fill', 'black', 'text:-',  "prints/song" + str(mc.sessionvars["songnumber"]) +".png"), stdin=cattext.stdout)
		cattext.wait()
